...
| **Compute Scaling Caps** | `ReservedConcurrentExecutions` limits (**50** for API Lambda, **2** for SQS NLP Worker). | Caps the maximum number of concurrent running containers AWS can spin up under a flood. |
